...
local Themes = {
    ...
    LonelyRed = {
        Name = "Lonely Red",
        Accent = Color3.fromRGB(61, 187, 102),
        AcrylicMain = Color3.fromRGB(40, 0, 0),
        AcrylicBorder = Color3.fromRGB(90, 30, 30),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(60, 0, 0), Color3.fromRGB(45, 0, 0)),
        AcrylicNoise = 0.8,
        TitleBarLine = Color3.fromRGB(120, 20, 20),
        Tab = Color3.fromRGB(255, 100, 100),
        Element = Color3.fromRGB(230, 70, 70),
        ElementBorder = Color3.fromRGB(100, 20, 20),
        InElementBorder = Color3.fromRGB(160, 40, 40),
        ElementTransparency = 0.85,
        ToggleSlider = Color3.fromRGB(255, 90, 90),
        ToggleToggled = Color3.fromRGB(150, 40, 40),
        SliderRail = Color3.fromRGB(255, 90, 90),
        DropdownFrame = Color3.fromRGB(255, 120, 120),
        DropdownHolder = Color3.fromRGB(60, 0, 0),
        DropdownBorder = Color3.fromRGB(100, 20, 20),
        DropdownOption = Color3.fromRGB(220, 80, 80),
        Keybind = Color3.fromRGB(230, 70, 70),
        Input = Color3.fromRGB(255, 120, 120),
        InputFocused = Color3.fromRGB(50, 0, 0),
        InputIndicator = Color3.fromRGB(255, 120, 120),
        Dialog = Color3.fromRGB(60, 0, 0),
        DialogHolder = Color3.fromRGB(45, 0, 0),
        DialogHolderLine = Color3.fromRGB(80, 20, 20),
        DialogButton = Color3.fromRGB(80, 0, 0),
        DialogButtonBorder = Color3.fromRGB(150, 30, 30),
        DialogBorder = Color3.fromRGB(100, 20, 20),
        DialogInput = Color3.fromRGB(80, 0, 0),
        DialogInputLine = Color3.fromRGB(255, 90, 90),
        Text = Color3.fromRGB(255, 240, 240),
        SubText = Color3.fromRGB(255, 170, 170),
